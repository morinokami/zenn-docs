...
Starlight は、Astro の上に構築された、ドキュメントサイト向けのテーマです。5 月 9 日に [v0.0.1](https://github.com/withastro/starlight/releases/tag/%40astrojs%2Fstarlight%400.0.1) がリリースされ、現在の最新版は [v0.15.1](https://github.com/withastro/starlight/releases/tag/%40astrojs%2Fstarlight%400.15.1) となっています。Astro v4 のリリースに合わせてドキュメントサイトが刷新されましたが、その際に全面的に Starlight へと[移行されました](https://github.com/withastro/docs/pull/4266)。
